...
export default function TelegramUserInfo() {
  const { user, initData, platform, version, colorScheme, isReady, hapticFeedback, showAlert, showConfirm } = useTelegram()
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-4">Telegram Web App Info</h1>
          
          {user ? (
            <div className="space-y-3">
              <h2 className="text-lg font-semibold text-green-600">✅ User Information</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {user.language_code && (
                  <div className="bg-gray-50 p-3 rounded">
                    ...
                    <span className="ml-2 text-gray-900">{user.language_code}</span>
                  </div>
                )}
                {user.is_premium !== undefined && (
                  <div className="bg-gray-50 p-3 rounded">
                    <span className="font-medium text-gray-700">Premium:</span>
                    <span className={`ml-2 font-medium ${user.is_premium ? 'text-yellow-600' : 'text-gray-600'}`}>
            ...
            <div className="text-center py-8">
              <div className="text-yellow-600 text-lg mb-2">⚠️ No User Information</div>
              <p className="text-gray-600">
                This app is running outside of Telegram or user data is not available.
              </p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-gray-50 p-3 rounded">
              <span className="font-medium text-gray-700">Init Data Length:</span>
              <span className="ml-2 text-gray-900">{initData.length} chars</span>
            </div>
          </div>
        </div>

        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Telegram Features</h2>
          <div className="space-y-3">
            <button
        ...
        {initData && (
          <div className="bg-white rounded-lg shadow-md p-6 mt-6">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Raw Init Data</h2>
            ...
            <p className="text-sm text-gray-500 mt-2">
              This data can be sent to your backend to verify the user's identity.
            </p>
          </div>
        )}
      </div>
